namespace Modbus.Message
{
    ...
    /// 
    /// </summary>
    public class ReadHoldingInputRegistersRequest32 : ReadHoldingInputRegistersRequest, IModbusRequest
    {
        /// <summary>
        /// 
        /// </summary>
        public ReadHoldingInputRegistersRequest32()
        {
        }
        ...
        public ReadHoldingInputRegistersRequest32(byte functionCode, byte slaveAddress, ushort startAddress, ushort numberOfPoints)
        ...
        public void ValidateResponse(IModbusMessage response)
        {
            ...
            if (expectedByteCount * RegisterSize / 2 != typedResponse.ByteCount)
            {
